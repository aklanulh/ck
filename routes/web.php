...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('/admin/export-absensi-excel', [AdminController::class, 'exportAbsensiExcel'])->name('admin.absensi.export.excel');
        Route::post('/admin/export-reports-excel', [AdminController::class, 'exportReportsExcel'])->name('admin.reports.export.excel');
